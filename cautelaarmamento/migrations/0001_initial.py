# Generated by Django 5.1 on 2024-12-13 21:34
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('categoria_armamento', models.CharField(blank=True, max_length=100, null=True, validators=[django.core.validators.MaxLengthValidator(100)])),
                ('subcategoria_armamento', models.CharField(blank=True, max_length=100, null=True, validators=[django.core.validators.MaxLengthValidator(100)])),
                ('categoria_municao', models.CharField(blank=True, max_length=100, null=True, validators=[django.core.validators.MaxLengthValidator(100)])),
                ('subcategoria_municao', models.CharField(blank=True, max_length=100, null=True, validators=[django.core.validators.MaxLengthValidator(100)])),
                ('quantidade_municao', models.IntegerField()),
                ('situacao_armamento', models.CharField(max_length=100, validators=[django.core.validators.MaxLengthValidator(100)])),
                ('observacao', models.TextField(blank=True, null=True, validators=[django.core.validators.MaxLengthValidator(1000)])),
                ('observacoes', models.TextField(blank=True, null=True, validators=[django.core.validators.MaxLengthValidator(1000)])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('num_arma', models.CharField(blank=True, max_length=100, null=True, verbose_name='Nº ARMA')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('data_descautelamento', models.DateTimeField(default=django.utils.timezone.now)),
                ('armeiro', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL)),
