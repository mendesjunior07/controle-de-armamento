...
from .models import PolicialMilitar, Armas, Vtr, Cautela
...
class ArmasAdmin(admin.ModelAdmin):
    list_display = ('tipo', 'modelo', 'numero_de_serie', 'disponivel')
...
class CautelaAdmin(admin.ModelAdmin):
    ...
    search_fields = ('policial__nome', 'armamento__modelo')
    list_filter = ('data_cautela', 'data_descautela')
    autocomplete_fields = ['policial', 'armamento']
