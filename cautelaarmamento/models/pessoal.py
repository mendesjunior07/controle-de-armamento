...
class PolicialMilitar(models.Model):
    ...
    numero_identificacao = models.CharField(max_length=50, unique=True)  # ID único para cada PM
    cpf = models.CharField(max_length=14, unique=True)  # Cadastro de Pessoa Física
    ...
    # Dados de serviço
    patente = models.CharField(max_length=50)  # Exemplo: "Soldado", "Cabo", "Sargento", etc.
    unidade = models.CharField(max_length=100)  # Unidade onde serve
    data_ingresso = models.DateField()  # Data de ingresso na corporação
    lotacao_atual = models.CharField(max_length=100, blank=True, null=True)  # Seção, unidade atual
